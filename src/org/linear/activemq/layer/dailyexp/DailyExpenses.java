 ...
 **************************************************************************************/
package org.linear.activemq.layer.dailyexp;
...
public class DailyExpenses
{
    ...
    public DailyExpenses() throws Exception
    {
        ...
        int port = Integer.parseInt(properties.getProperty(Constants.MGMT_RMI_PORT_DAILYEXP_LAYER));
        ...
        String jmsurl = properties.getProperty(Constants.JMS_PROVIDER_URL_DAILYEXP_LAYER);
        ...
        String destination = properties.getProperty(Constants.JMS_INCOMING_DESTINATION_DAILYEXP_LAYER);
        ...
        DailyExpensesListener listeners[] = new DailyExpensesListener[numListeners];
        for (int i = 0; i < numListeners; i++)
        {
            listeners[i] = new DailyExpensesListener(engine.getEPRuntime());
